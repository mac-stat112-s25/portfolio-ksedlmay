...
Think: What *confounding* or *lurking* or *omitted* variable related to energy usage are we ignoring here?
...
fave_places <- read.csv("C:/STAT112/Data_Folder/our_fave_places.csv")
