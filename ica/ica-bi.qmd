...
-   the strength of the relationship (weak/moderate/strong)\
  There is strong correlation, shown by the average 1/1 slope.
-   the direction of the relationship (positive/negative)\
  Positive relationship
-   outliers (in what state do counties deviate from the national trend? Any ideas why this might be the case?)
  Texas normally has a higher percentage, this is due to texas being very republican.
...
Summarize what you've learned about the 2020 Republican county-level support within and between red/purple/blue states.
  The blue states are historically blue, the red states are historically red, and the purple states are historical neutral
...
-   Which do you like best?
  I like the density plot with the plots see through so you can see the data better.
-   What is one pro of density plots relative to boxplots?
  Better visualization
-   What is one con of density plots relative to boxplots?
  Not precise for quantitative variables.
...
ggplot(elections, aes(x = historical, fill = winner_20)) +
  geom_bar() +
  scale_fill_manual(values = c("dem" = "red", "repub" = "cyan")) +
  theme_minimal()
```
...
Name one pro and one con of using the "proportional bar plot" instead of one of the other three options.
            Cant see shape of data, just the dispersion across the bcategories

#### Part b {.unnumbered}

What's your favorite bar plot from part and why?
    I like the dodge bar chart because it shows a clear visual comparison of the data
